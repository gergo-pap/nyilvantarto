...
namespace Nyilvantarto_v2
{
	public partial class FormSzakmaiVizsgaTörzslap : Form
	{
		...
		public FormSzakmaiVizsgaTörzslap()
		{
			...
			conn.Open();
			Global.CreateTableDokumentumok();
			Global.getDestPathFromDatabase();
		}
		...
		private void FormSzakmaiVizsgaTörzslap_Load(object sender, EventArgs e)
		{
			...
			Global.checkMissingFile(@"\Adatok\Szakmai vizsga\Törzslap\", "szvt_tanuloNeve", "szvt_viszgaEvKezdet", "szvt_viszgaTavasz1Osz0", "szvt_AnyjaNeve", "szakmaivizsgaTorzslap", labelFileokSzama, labelDBCount);
			watch.Stop();
		...
		{
			Global.bordercolorReset(textBoxAnyjaNeveFeltolt, textBoxDokumentumNeve, textBoxTanuloNeveFeltolt, textBoxEleresi);
		}
		...
		{
			Global.textBoxTextChanged(textBoxDokumentumNeve);
		}

		private void textBoxEleresi_TextChanged(object sender, EventArgs e)
		{
			Global.textBoxTextChanged(textBoxEleresi);
		}

		private void buttonTallozas_Click(object sender, EventArgs e)
		{
			Global.tallozas(textBoxDokumentumNeve, textBoxEleresi);
		}
		...
		private void buttonFeltoltes_Click(object sender, EventArgs e)
		{
			if (checkIfEmptyInput())
			{
				Global.fileFeltolteseBDreESFileMozgatasa(textBoxAnyjaNeveFeltolt, textBoxTanuloNeveFeltolt, textBoxEleresi, radioButtonOszFeltolt, numericUpDownEvFeltoltKezdet,
					...
					"szvt_dokLegutobbModositva", "szvt_feltoltesIdopontja", "szvt_formatum", "szvt_path");
				Global.textBoxFeltoltUrites(textBoxDokumentumNeve, textBoxEleresi, textBoxTanuloNeveFeltolt, textBoxAnyjaNeveFeltolt);
				borderColorReset();
			}
			Global.getCount(labelFileokSzama, labelDBCount, @"\Adatok\Szakmai vizsga\Törzslap\", "szakmaivizsgaTorzslap");
		}
		...
		private void textBoxTanuloNeveKeres_TextChanged(object sender, EventArgs e)
		{
			...
			if (checkBoxOsszetett.Checked)
			{
				Global.osszetettKeresv2("szvt_tanuloNeve", "szvt_viszgaEvKezdet", "szvt_viszgaTavasz1Osz0", "szvt_AnyjaNeve",
					...
					"szvt_viszgaEvKezdet", numericUpDownVizsgaKezdetKeres.Value.ToString(),
			...
			else
			{
				...
				{
					Global.osszetettKeres("szvt_tanuloNeve", "szvt_viszgaEvKezdet", "szvt_viszgaTavasz1Osz0", "szvt_AnyjaNeve", "szakmaivizsgaTorzslap", "szvt_tanuloNeve", textBoxTanuloNeveKeres.Text, "szvt_AnyjaNeve", textBoxAnyjaNeveKeres.Text, listBoxId, listBoxKeresesEredmenyeTanuloNeve, listBoxVKezdete, listboxIdoszak, listBoxAnyjaNeve);
				}
				else if (textBoxTanuloNeveKeres.Text.Length > 4)
				{
					Global.keres("szvt_tanuloNeve", "szvt_viszgaEvKezdet", "szvt_viszgaTavasz1Osz0", "szvt_AnyjaNeve", "szakmaivizsgaTorzslap", textBoxTanuloNeveKeres.Text, listBoxId, listBoxKeresesEredmenyeTanuloNeve, listBoxVKezdete, listboxIdoszak, listBoxAnyjaNeve);
				}
			}
		...
		private void textBoxAnyjaNeveKeres_TextChanged(object sender, EventArgs e)
		{
			...
			else
			{
				...
				{
					Global.keres("szvt_AnyjaNeve", "szvt_viszgaEvKezdet", "szvt_viszgaTavasz1Osz0", "szvt_AnyjaNeve", "szakmaivizsgaTorzslap", textBoxAnyjaNeveKeres.Text, listBoxId, listBoxKeresesEredmenyeTanuloNeve, listBoxVKezdete, listboxIdoszak, listBoxAnyjaNeve);
		...
		private void buttonTorles_Click(object sender, EventArgs e)
		{
			...
			{
				Global.torles(listBoxId, "szakmaivizsgaTorzslap");
				Global.getCount(labelFileokSzama, labelDBCount, @"\Adatok\Szakmai vizsga\Törzslap\", "szakmaivizsgaTorzslap");
